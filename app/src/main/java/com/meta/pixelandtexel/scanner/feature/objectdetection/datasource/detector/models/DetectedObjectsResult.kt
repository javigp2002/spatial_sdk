...
package com.meta.pixelandtexel.scanner.feature.objectdetection.datasource.detector.models
...
data class DetectedObjectsResult(
    ...
    companion object {
         ...
         *
         * This function converts a list of [Detection]
         ...
         */
        fun fromMPResults(
            mpDetectedObjects: List<Detection>,
            inferenceTime: Long,
            inputImageWidth: Int,
